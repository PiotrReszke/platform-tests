...
class Seahorse():
    ...
    def __init__(self, org_uuid, space_uuid):
        # service_instance = ServiceInstance.api_create_with_plan_name(org_uuid, space_uuid,
        #                                                              self.seahorse_label,
        ...
        self.seahorse_url = "localhost:8080"
        # self.seahorse_http_url = 'https://' + self.seahorse_url
        self.seahorse_http_url = 'http://' + self.seahorse_url
    ...
    def _ensure_wm_accessible(self):
        response = self.session.get(self.seahorse_http_url + '/v1/workflows').raise_for_status()
