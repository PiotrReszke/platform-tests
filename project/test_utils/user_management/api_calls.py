...
def api_get_organizations():
    ...
    return get_app_client().call(APP_NAME, "get_organizations")


def api_create_organization(name):
    """POST /rest/orgs"""
    logger.info("------------------ Create organization with name {} ------------------".format(name))
    return get_app_client().call(APP_NAME, "create_organization", body={"name": name})


def api_delete_organization(org_guid):
    """DELETE /rest/orgs/{organization_guid}"""
    logger.info("------------------ Delete organization {} ------------------".format(org_guid))
    return get_app_client().call(APP_NAME, "delete_organization", organization_guid=org_guid)
...
def api_rename_organization(org_guid, new_name):
    ...
    return get_app_client().call(APP_NAME, "rename_organization", organization_guid=org_guid, body={"name": new_name})
...
def api_create_organization_user(org_guid, username, roles=None):
    ...
    return get_app_client().call(APP_NAME, "create_organization_user", organization_guid=org_guid, body=body)
...
def api_get_organization_users(org_guid):
    ...
    return get_app_client().call(APP_NAME, "get_organization_users", organization_guid=org_guid)
...
def api_delete_organization_user(org_guid, user_guid):
    ...
    return get_app_client().call(APP_NAME, "delete_organization_user", organization_guid=org_guid, user_guid=user_guid)
...
def api_update_organization_user(org_guid, user_guid, new_roles=None):
    ...
    return get_app_client().call(APP_NAME, "update_organization_user", organization_guid=org_guid, user_guid=user_guid, body=body)
...
def api_create_space_user(org_guid, space_guid, username, roles=None):
    ...
    return get_app_client().call(APP_NAME, "create_space_user", space_guid=space_guid, body=body)


def api_get_space_users(space_guid):
    """GET /rest/spaces/{space_guid}/users"""
    logger.info("------------------ Get users from space {} ------------------".format(space_guid))
    return get_app_client().call(APP_NAME, "get_space_users", space_guid=space_guid)
...
def api_delete_space_user(space_guid, user_guid):
    ...
    return get_app_client().call(APP_NAME, "delete_space_user", space_guid=space_guid, user_guid=user_guid)
...
def api_update_space_user(org_guid, space_guid, user_guid, new_username=None, new_roles=None):
    ...
    if new_roles is not None:
        body["roles"] = new_roles
    return get_app_client().call(APP_NAME, "update_space_user", space_guid=space_guid, user_guid=user_guid, body=body)
