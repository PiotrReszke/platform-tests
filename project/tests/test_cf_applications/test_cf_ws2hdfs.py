...
class CFApp_ws2kafka_kafka2hdfs(ApiTestCase):
    ...
    def test_cf_app_ws2kafka_kafka2hdfs(self):
        ...
        time.sleep(60)
        cf_status_stats = self.app_kafka2hdfs.application_api_request(endpoint="status/stats")
        ...
        topic = Topic(node_name="ip-10-10-10-236", broker_instance_guid=broker_guid, topic_catalog="from_kafka",
